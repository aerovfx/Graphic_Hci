/* Graphics & HCI Learning Hub — shared top navigation for classroom tools. */
(function () {
  'use strict';
  var items = [
  ...
  function boot() {
    ...
    nav.innerHTML = '<a class="science-nav-brand" href="../../index.html" aria-label="Graphics & HCI Learning Hub">' +
      '<span>⚛</span><b>Science</b></a>' +
